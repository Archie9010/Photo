 ...
 * Navbar actively displays appropriate icons, also text is displayed when hovered over.
6. As a user I can maintain my logged-in status until I choose to log out so that my user experience is not compromised
 * User is able to stay logged in on site and log out on demand
 ...
 * Users visiting website can see avatars of existing users profiles
